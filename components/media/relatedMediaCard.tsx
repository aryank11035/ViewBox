    ...
    return (
            ...
            <Link href={`/${mediaData.mediaType ? mediaData.mediaType : mediaData.media_type}/${mediaData.id}`}  key={mediaData.id} > 
                <motion.div
                    ...
                    className="max-w-full aspect-[2/3] relative rounded-xs bg-black/30 overflow-hidden shadow-xl flex cursor-pointer"
                >
                    ...
                    <motion.div 
                        ...
                        className="w-full h-[33%] relative bg-[#111111] bottom-0 rounded-b-xs py-2 flex flex-col justify-between self-end "
                    >
