...
export default function MediaSection({movies, tv, yourMedia } : {movies : any , tv : any, yourMedia : any } ){
    ...
    return(
        ...
        <section className="max-w-[1800px] min-h-screen mx-auto border-l border-r  border-white/10 px-5 py-10 bg-[#111111] relative  ">
            ...
            { yourMedia.length > 0 &&  (<div className="w-full h-fit">
