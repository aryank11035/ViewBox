            ...
            <div className = 'w-full relative md:pt-0 pt-10 md:px-0 px-2'>    
                <div className="inset-0 w-full h-[250px] relative hidden md:block ">
                        ...
                        {mediaData.backdrop_path ? (
                            ...
                            h-[250px]
                            absolute inset-0 
                            bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.4)_0,rgba(255,255,255,0.4)_1px,transparent_0,transparent_50%)]
                            bg-[size:10px_10px] 
                            bg-fixed">
                            </div>
                                    ...
                                    <button  onClick={(e) => {
                                        ...
                                        e.preventDefault()
                                                ...
                                                <p className="text-center">
                                                    {loading? 'Adding..' :  addedToWatchlist ? 'Added' : ' Add to Watchlist'}
                                                </p> 
